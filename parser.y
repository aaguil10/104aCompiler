...
%token  VOID BOOL NOTCHAR CHAR INT STRING STRUCT IF ELSE WHILE RETURN FALSE
%token  TRUE TOK_NULL ORD CHR NEW CHAR_CONST STRING_CONST
%token  ROOT IDENT NOTIDENT NUMBER SQUBRACKETS GREAEQU LESSEQU NEQUAL EQUALS
